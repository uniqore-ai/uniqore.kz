(function(){
  ...
  function renderDetail(container){
    ...
    var primary = item.status === 'live'
      ? '<a class="btn btn-primary" href="/download/">Скачать и запустить</a>'
      : '<a class="btn btn-primary" href="mailto:hi@uniqore.ai?subject=' + encodeURIComponent(item.title) + '">Узнать о запуске</a>';
